...
wk.add({
    { "<leader>p", "+Rocks" },
    { "<leader>pe", "<cmd>Rocks edit<cr>", desc = "Rocks Edit" },
    { "<leader>pl", "<cmd>Rocks log<cr>", desc = "Rocks Log" },
    { "<leader>ps", "<cmd>Rocks sync<cr>", desc = "Rocks Sync" },
    { "<leader>pu", "<cmd>Rocks update<cr>", desc = "Rocks Update" },
})
...
wk.add({
    ...
    { "<leader>rl", "<cmd>Rest last<CR>", desc = "Rerun" },
})
